            ...
            for j in range(0, self.towerColumnCount):
                if i == 0 and j == 0:  # Przykład warunku dla SniperTower
                    self.item = Button(self.towerPanel,
                                       ...
                                       image_path=os.path.join(self.itemPath, 'MageTower', 'MageTower0.png'))
                ...
                if i == 0 and j == 2:  # Przykład warunku dla SniperTower
                    self.item = Button(self.towerPanel,
                                       ...
                                       image_path=os.path.join(self.itemPath, 'Witchhouse', 'Witchhouse0.png'))
                ...
                if i ==1 and j == 2:
                    self.item = Button(self.towerPanel,
                                       ...
                                       image_path=os.path.join(self.itemPath, 'Factory', 'Factory0.png'))
