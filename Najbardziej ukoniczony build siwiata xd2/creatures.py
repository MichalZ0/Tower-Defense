...
class Monster(pygame.sprite.Sprite):
    def __init__(
        ...
        self.frames = [
            pygame.image.load(os.path.join(self.basePath, path)).convert_alpha()
            for path in image_paths
        ]
        self.frames = [
            pygame.transform.scale(frame, image_size) for frame in self.frames
        ]
        ...
        if self.animation_counter >= self.animation_speed:
            ...
            if self.flip_to_left:
                self.image = pygame.transform.flip(
                    self.frames[self.current_frame], True, False
                )
            self.animation_counter = 0
    ...
    def move_towards_next_waypoint(self):
        ...
        if (
            distance < self.speed
        ):  # Jeśli jest bardzo blisko punktu, uznajemy, że dotarł
            ...
            if self.waypoints[-1] == self.waypoints[self.waypoint_index]:
                ...
                if not self.reached_end:
                    ...
                    self.kill()
            if not (
                self.waypoints[-1] == self.waypoints[self.waypoint_index]
            ):  # to musi byc bo inaczej blad 2 linijki nizej - sprawdzenie czy to juz nie ostatni waypoint
                self.waypoint_index += 1  # Przejście do kolejnego punktu
                self.flip_to_left = False

            if (self.waypoints[self.waypoint_index - 1])[0] > (
            ...
            self.rect.bottomleft = (
                self.position
            )  # Aktualizacja pozycji `rect` dla kolizji
    ...
    def update(self):
        ...
        if (
            pygame.time.get_ticks() > self.slow_end_time
            and self.speed != self.original_speed
        ):
...
class Dragon(Monster):
    def __init__(
        self, position, waypoints, image_size, sf, animation_speed=10, speed=11
    ):
        super().__init__(
            name="Dragon",
            health=500,
            ...
            image_paths=["dragon.png", "dragon1.png", "dragon2.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
...
class Troll(Monster):
    def __init__(
        self, position, waypoints, image_size, sf, animation_speed=10, speed=3
    ):
        super().__init__(
            name="Troll",
            health=600,
            ...
            image_size=image_size,
            animation_speed=animation_speed,
            image_paths=["troll.png", "troll1.png", "troll2.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
...
class Goblin(Monster):
    def __init__(
        ...
        super().__init__(
            ...
            image_size=image_size,
            animation_speed=animation_speed,
            image_paths=["goblin.png", "goblin2.png", "goblin1.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
...
class Hydra(Monster):
    def __init__(
        ...
        super().__init__(
            ...
            image_size=image_size,
            animation_speed=animation_speed,
            image_paths=["hydra.png", "hydra1.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
...
class Skeleton(Monster):
    def __init__(
        ...
        super().__init__(
            ...
            image_size=image_size,
            animation_speed=animation_speed,
            image_paths=["skeleton.png", "skeleton1.png", "skeleton2.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
...
class Thief(Monster):
    def __init__(
        ...
        super().__init__(
            ...
            image_size=image_size,
            animation_speed=animation_speed,
            image_paths=["thief2.png", "thief1.png", "thief.png"],
            position=position,
            waypoints=waypoints,
            sf=sf,
        )
