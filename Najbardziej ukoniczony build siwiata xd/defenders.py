...
class Cannon(pygame.sprite.Sprite):
    def __init__(
        ...
        self.game=0
        self.damage=150
        self.path=os.path.join(os.getcwd(),"assets",'sounds','soundstd','shooting')
        self.sound = pygame.mixer.Sound(os.path.join(self.path,"cannon.mp3"))
...
class MageTower(Cannon):
    def __init__(
        ...
        self.damage=150
        self.path = os.path.join(os.getcwd(), "assets", 'sounds', 'soundstd', 'shooting')
        self.sound = pygame.mixer.Sound(os.path.join(self.path, "magic-dark.ogg"))
    ...
    def upgrade(self):
        ...
        if self.level2 == 1:
            if self.level == 2:
                if self.game.money >= (self.upPrice2 + 100):
...
class Archer(Cannon):
    def __init__(
        ...
        self.damage=150
        self.path = os.path.join(os.getcwd(), "assets", 'sounds', 'soundstd', 'shooting')
        self.sound = pygame.mixer.Sound(os.path.join(self.path, "bow.mp3"))
...
class Temple(Cannon):
    def __init__(
        ...
        self.damage=150
        self.path = os.path.join(os.getcwd(), "assets", 'sounds', 'soundstd', 'shooting')
        self.sound = pygame.mixer.Sound(os.path.join(self.path, "fire.mp3"))
