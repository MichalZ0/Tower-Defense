...
class Waves:
    def __init__(self, sf, screen, difficulty = 'easy', mapName='Greenfield',max_waves=50):
        ...
        self.won = False
        self.lost = False
        self.map_base_spawn_pointDict = {'Greenfield':(-250 / 8, 3100 / 6), 'Desert': (2150 / 8, 4100 / 6),'Cave':(670/8, 170/6) }  # dla mapy 1
        ...
        self.map_start_coefficient_xDict = {'Cave':-math.sqrt(2),'Desert': 0,'Greenfield': -2}
        self.map_start_coefficient_yDict = {'Cave': -math.sqrt(2), 'Desert': 2, 'Greenfield': 0}
        ...
        self.map_start_coefficient_x = self.map_start_coefficient_xDict[mapName]
        self.map_start_coefficient_y = self.map_start_coefficient_yDict[mapName]
        self.map_base_spawn_point=self.map_base_spawn_pointDict[mapName]
